...
export class Loader {
    ...
    private static loadAudio(): void {
        for (let audio in Assets.Audio) {
            let soundName: string = Assets.Audio[audio].getName();
            this.soundKeys.push(soundName);

            if (!this.game.cache.checkSoundKey(soundName)) {
                let audioTypeArray: string[] = [];
    ...
    private static loadAudiosprites(): void {
        for (let audio in Assets.Audiosprites) {
            let soundName: string = Assets.Audiosprites[audio].getName();
            this.soundKeys.push(soundName);
    ...
    public static loadAllAssets(game: Phaser.Game, onComplete?: Function, onCompleteContext?: any): void {
        this.game = game;
    ...
    public static waitForSoundDecoding(onComplete: Function, onCompleteContext?: any): void {
