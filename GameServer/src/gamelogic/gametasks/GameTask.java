...
public abstract class GameTask
{
     ...
     * @param arguments The arguments of the command, space separated in a single string.
     * @return A boolean value representing whether the command was executed by the task.
     */
