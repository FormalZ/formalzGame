...
import gamelogic.gamestate.CheatDetector;
import gamelogic.gamestate.GameState;
import gamelogic.gamestate.ProblemState;
import gamelogic.gametasks.GameLogicTask;
import gamelogic.gametasks.GameTask;
import haskellapi.Response;
import logger.AbstractLogger;
import utils.Tracker;

public class _GameLogicTaskTest
{
    @Rule
    ...
    public void testWaveDoneCommandIncorrect()
    {
        ...
        verify(MConnection, times(1)).sendSpawnWave(anyInt(), anyInt(), anyInt(), anyInt(), notNull(), notNull(), notNull());
    }
    ...
    public void testWaveDoneCommandCorrectIntermediateProblem()
    {
        ...
        verify(MGameState, times(1)).setScore(anyInt());
        verify(MConnection, times(1)).startNewQuestion(notNull(), MClient.getLogger(), anyInt());
    }
