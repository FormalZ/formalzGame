...
public class _GameStateTest
{
    ...
    {
        GameState state = new GameState(MLogger);
    ...
    /**
     * Test whether correct problems are received when the game progresses correctly.
    ...
    public void testGetProblemAndProcessCorrectAnswer() throws Exception
    {
        ...
        when(MQueries.getRandomRepoProblemWithProperties(notNull(), any(), anyInt(), anyInt(), anyInt(), anyInt(), anyInt())).thenReturn(MRepoProblem1);
        ...
        when(MQueries.getRandomRepoProblemWithProperties(notNull(), any(), anyInt(), anyInt(), anyInt(), anyInt(), anyInt())).thenReturn(MRepoProblem2);
    ...
    /**
     * Test whether correct problems are received when the player answers questions wrongly.
     * @throws Exception Some exception.
     */
    @Test
    public void testGetProblemAndProcessInCorrectAnswer() throws Exception
    {
        ...
        when(MQueries.getProblemById(anyInt())).thenReturn(MTeacherProblem);
        when(MQueries.getRandomRepoProblemWithProperties(any(), any(), anyInt(), anyInt(), anyInt(), anyInt(), anyInt())).thenReturn(MRepoProblem1);
    ...
    public void testEndGameGood()
    {
        ...
        verify(MQueries, times(1)).insertStatistics(anyInt(), anyInt(), anyInt(), anyInt(), anyInt(), anyInt(), anyInt());
        assertTrue(state.isFinished());
