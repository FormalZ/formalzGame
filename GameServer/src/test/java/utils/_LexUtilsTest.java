...
public class _LexUtilsTest
{
    ...
    public void lexTestSort()
    {
        ...
        Token[] output = new Token[] { new Token(TokenType.Quantifier, "forall"), new Token(TokenType.Syntax, "("),
                new Token(TokenType.Variable, "a"), new Token(TokenType.Syntax, ","), new Token(TokenType.Variable, "i"),
                new Token(TokenType.Syntax, "->"), new Token(TokenType.Variable, "a"), new Token(TokenType.ArrayIndex, "["),
                new Token(TokenType.Variable, "i"), new Token(TokenType.ArrayIndex, "]"), new Token(TokenType.RelationalComparer, ">="),
                new Token(TokenType.Variable, "a"), new Token(TokenType.ArrayIndex, "["), new Token(TokenType.Variable, "i"),
                new Token(TokenType.Arithmetic, "+"), new Token(TokenType.Number, "1"), new Token(TokenType.ArrayIndex, "]"),
    ...
    public void lexTestArrayNull()
    {
        ...
        Token[] output = new Token[] { new Token(TokenType.Variable, "a"), new Token(TokenType.EqualityComparer, "!="),
                new Token(TokenType.Null, "null"), new Token(TokenType.LogicOperator, "&&"), new Token(TokenType.Variable, "a"),
                new Token(TokenType.Length, ".length"), new Token(TokenType.RelationalComparer, ">"), new Token(TokenType.Number, "0") };
        assertArrayEquals(output, LexUtils.lex(input));
    }

    /**
     * Test whether a condition containing logic operators and booleans is lexed correctly.
     */
    @Test
    public void lexTestBoolLogic()
    {
        ...
        Token[] output = new Token[] { new Token(TokenType.Not, "!"), new Token(TokenType.Variable, "a"),
                new Token(TokenType.EqualityComparer, "!="), new Token(TokenType.Boolean, "true"), new Token(TokenType.LogicOperator, "&&"),
                new Token(TokenType.LogicOperator, "||"), new Token(TokenType.Boolean, "false") };
        assertArrayEquals(output, LexUtils.lex(input));
    }
    ...
    {
        String input = "<<>===>!=";
        Token[] output = new Token[] { new Token(TokenType.RelationalComparer, "<"), new Token(TokenType.RelationalComparer, "<"),
    ...
    public void lexTestVarsNums()
    {
        ...
        Token[] output = new Token[] { new Token(TokenType.Variable, "_ASDFddds"), new Token(TokenType.Quantifier, "exists"),
                new Token(TokenType.Real, "1.23"), new Token(TokenType.Arithmetic, "%"), new Token(TokenType.Number, "5"),
                new Token(TokenType.Variable, "abe54"), new Token(TokenType.Syntax, "("), new Token(TokenType.Syntax, ")"),
                new Token(TokenType.Real, "0.5f"), new Token(TokenType.QuantifierR, "forallr") };
        assertArrayEquals(output, LexUtils.lex(input));
    }
    ...
    public void lexTestImp()
    {
        ...
        Token[] output = new Token[] { new Token(TokenType.Implication, "imp"), new Token(TokenType.Syntax, "("),
                new Token(TokenType.Boolean, "true"), new Token(TokenType.Syntax, ","), new Token(TokenType.Boolean, "true"),
                new Token(TokenType.LogicOperator, "&&"), new Token(TokenType.Variable, "b"), new Token(TokenType.Syntax, ")") };
        assertArrayEquals(output, LexUtils.lex(input));
    }
    ...
    public void lexTestWith()
    {
        ...
        Token[] output = new Token[] { new Token(TokenType.With, "with"), new Token(TokenType.Syntax, "("),
                new Token(TokenType.Variable, "a"), new Token(TokenType.ArrayIndex, "["), new Token(TokenType.Variable, "i"),
                new Token(TokenType.ArrayIndex, "]"), new Token(TokenType.Syntax, ","), new Token(TokenType.Variable, "ai"),
                new Token(TokenType.Syntax, "->"), new Token(TokenType.Variable, "ai"), new Token(TokenType.Syntax, ")") };
        assertArrayEquals(output, LexUtils.lex(input));
    }
    ...
    {
        Token[] input = new Token[] { new Token(TokenType.Quantifier, "exists"), new Token(TokenType.Quantifier, "exists"),
                new Token(TokenType.Syntax, "("), new Token(TokenType.RelationalComparer, "<"),
                new Token(TokenType.RelationalComparer, "<"), new Token(TokenType.RelationalComparer, ">="),
                new Token(TokenType.EqualityComparer, "=="), new Token(TokenType.Number, "12"), new Token(TokenType.Syntax, "("),
                new Token(TokenType.Syntax, ")"), new Token(TokenType.EqualityComparer, "!=") };
        String[] output = new String[] { new Token(TokenType.Quantifier, "exists").toString(),
                new Token(TokenType.RelationalComparer, "<").toString(), new Token(TokenType.RelationalComparer, ">=").toString(),
    ...
    public void textExtendTokens()
    {
        Token[] input = new Token[] { new Token(TokenType.Quantifier, "exists"), new Token(TokenType.Syntax, "("),
                new Token(TokenType.RelationalComparer, "<"), new Token(TokenType.RelationalComparer, ">="),
                new Token(TokenType.EqualityComparer, "=="), new Token(TokenType.Number, "12"), new Token(TokenType.Syntax, "("),
                new Token(TokenType.Syntax, ")"), new Token(TokenType.EqualityComparer, "!="), new Token(TokenType.Boolean, "true"),
                new Token(TokenType.Arithmetic, "+") };
        Token[] output = new Token[] { new Token(TokenType.Quantifier, "exists"), new Token(TokenType.RelationalComparer, "<"),
                new Token(TokenType.RelationalComparer, "<="), new Token(TokenType.RelationalComparer, ">"),
                new Token(TokenType.RelationalComparer, ">="), new Token(TokenType.EqualityComparer, "!="),
                new Token(TokenType.EqualityComparer, "=="), new Token(TokenType.Number, "12"), new Token(TokenType.Boolean, "true"),
                new Token(TokenType.Boolean, "false"), new Token(TokenType.Arithmetic, "+"), new Token(TokenType.Arithmetic, "-") };
