...
public class _WaveDataTest
{
    ...
    {
        WaveData data = new WaveData(0, 100, 5050, 40, 5, new int[] { 5, 0, 0, 5 }, new int[] { 1, 2, 3, 4 }, new int[] { 5, 6, 7, 8 },
                new int[] { 9, 10, 11, 12 }, new int[] { 9, 12 }, new int[] { 10, 11 }, new int[] { 11, 12 }, new int[] { 9, 10 });
        assertEquals(0, data.getScore());
        assertEquals(100, data.getDeltaScore());
        assertEquals(5050, data.getMoney());
        assertEquals(40, data.getHealth());
