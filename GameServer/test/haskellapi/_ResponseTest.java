...
import haskellapi.Response.ResponseType;
...
public class _ResponseTest
{
    ...
    /**
     * Test whether the constructor works when there is a correct response and with equivalent result.
     */
    @Test
    ...
    /**
     * Test whether the constructor works when there is a correct response and with not equivalen result.
     */
    @Test
    ...
    /**
     * Test whether a JSON object containing equivalent response is parsed correctly.
     */
    @Test
    public void testFromJsonObjectTrue()
    {
        JsonObject obj = new GsonBuilder().create().fromJson("{\"model\":null,\"err\":null,\"responseType\":\"Equiv\",\"feedback\":null}",
                JsonObject.class);
    ...
    /**
     * Test whether a JSON object containing not equivalent response is parsed correctly.
     */
    @Test
