...
public class IntegrationTestDatabaseFiller
{
     ...
     */
    private static void fillProblems()
    {
        Database.getInstance().queryVoid((con) ->
        {
            try
     ...
     */
    private static void fillGameSessions()
    {
        Database.getInstance().queryVoid((con) ->
        {
            try
            {
                PreparedStatement statement = con.prepareStatement(
                        "INSERT INTO gamesessions(id, user_id, problem_id, token, created_at) VALUES(?, ?, ?, ?, CURDATE())");
                statement.setInt(1, 1);
                statement.setInt(2, 1);
                statement.setInt(3, 1);
                statement.setString(4, "123abc456DEF");
                return statement;
            }
            catch (SQLException e)
            {
     ...
     */
    private static void insertHint(String id, String hint)
    {
        Database.getInstance().queryVoid((con) ->
        {
            try
     ...
     */
    private static void fillProblemRepo()
    {
        Database.getInstance().queryVoid((con) ->
        {
            try
